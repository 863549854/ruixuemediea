...
<script type="text/javascript" src="${staticUrl}js/lib/jqueryui/jquery-ui.min.js"></script>
<script type="text/javascript" src="${staticUrl}js/lib/lobipanel/lobipanel.min.js"></script>
